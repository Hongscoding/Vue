...
import DISubComponent from './components/sub4/DISubComponent.vue';

export default {
    name: "App",
    components: { Component1, MyComponent1, HooksComponent, DIComponent, DISubComponent },
    setup(){
